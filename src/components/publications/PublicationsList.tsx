                        ...
                        >
                            <div>
                                <div className="flex-grow">
                                    <h3 className={`${embedded ? "text-lg" : "text-xl"} font-semibold text-primary mb-[0.25rem] leading-tight`}>
                                        <FormattedBibTeXText nodes={pub.titleNodes} fallback={pub.title} />
                                    </h3>
                                    <p className={`${embedded ? "text-sm" : "text-base"} text-neutral-600 dark:text-neutral-400 mb-[0.25rem]`}>
                                    ...
                                    <p className="text-sm font-medium text-neutral-800 dark:text-neutral-600 mb-[0.25rem]">
                                    ...
                                    <div className="flex flex-wrap gap-2 mt-[0.3rem]">
                                        {pub.doi && (
                                            <a
